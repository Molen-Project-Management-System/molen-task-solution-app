...
{
    public partial class dbmolenContext : DbContext
    {
        public dbmolenContext()
        {
        }

        public dbmolenContext(DbContextOptions<dbmolenContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=144.126.158.15,1433;Database=dbmolen; User ID=administrator; Password=Qwert1234");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Task>(entity =>
            {
                entity.HasKey(e => e.TasksId)
                    .HasName("PK__Tasks__6DD789797DBBB143");
